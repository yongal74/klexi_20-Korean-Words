...
export const HANGEUL_SECTIONS: HangeulSection[] = [
  {
    ...
    chars: [
      { char: 'ㄱ', name: '기역', romanization: 'g/k', sound: 'Like "g" in "go" or "k" in "kite"', type: 'consonant', example: '가방', exampleMeaning: 'bag', tip: 'Softer "g" at the start, harder "k" at the end of syllables' },
      { char: 'ㄴ', name: '니은', romanization: 'n', sound: 'Like "n" in "nice"', type: 'consonant', example: '나라', exampleMeaning: 'country', tip: 'Same as English "n" - easy one!' },
      { char: 'ㄷ', name: '디귿', romanization: 'd/t', sound: 'Like "d" in "door" or "t" in "top"', type: 'consonant', example: '달', exampleMeaning: 'moon', tip: 'Softer "d" at start, sharper "t" at end' },
      { char: 'ㄹ', name: '리을', romanization: 'r/l', sound: 'Between "r" and "l"', type: 'consonant', example: '라면', exampleMeaning: 'ramen', tip: 'Flap your tongue like a soft "r" - unique Korean sound!' },
      { char: 'ㅁ', name: '미음', romanization: 'm', sound: 'Like "m" in "mom"', type: 'consonant', example: '마음', exampleMeaning: 'heart/mind', tip: 'Looks like a box - think of closing your lips to say "m"' },
      { char: 'ㅂ', name: '비읍', romanization: 'b/p', sound: 'Like "b" in "bus" or "p" in "park"', type: 'consonant', example: '바다', exampleMeaning: 'sea', tip: 'Soft "b" at start, firm "p" at end' },
      { char: 'ㅅ', name: '시옷', romanization: 's', sound: 'Like "s" in "sun"', type: 'consonant', example: '사랑', exampleMeaning: 'love', tip: 'Looks like a hat or tent shape' },
      { char: 'ㅇ', name: '이응', romanization: 'ng (or silent)', sound: 'Silent at start, "ng" at end', type: 'consonant', example: '아이', exampleMeaning: 'child', tip: 'Silent placeholder at start of syllable, "ng" sound at end' },
      { char: 'ㅈ', name: '지읒', romanization: 'j', sound: 'Like "j" in "just"', type: 'consonant', example: '자리', exampleMeaning: 'seat', tip: 'Think of it as a "j" sound' },
      { char: 'ㅊ', name: '치읓', romanization: 'ch', sound: 'Like "ch" in "church"', type: 'consonant', example: '친구', exampleMeaning: 'friend', tip: 'ㅈ with an extra stroke = aspirated (more air)' },
      { char: 'ㅋ', name: '키읔', romanization: 'k', sound: 'Like "k" in "king" (strong)', type: 'consonant', example: '커피', exampleMeaning: 'coffee', tip: 'ㄱ with an extra stroke = stronger, more air' },
      { char: 'ㅌ', name: '티읕', romanization: 't', sound: 'Like "t" in "top" (strong)', type: 'consonant', example: '토끼', exampleMeaning: 'rabbit', tip: 'ㄷ with an extra stroke = stronger' },
      { char: 'ㅍ', name: '피읖', romanization: 'p', sound: 'Like "p" in "park" (strong)', type: 'consonant', example: '피자', exampleMeaning: 'pizza', tip: 'ㅂ with an extra stroke = stronger' },
      { char: 'ㅎ', name: '히읗', romanization: 'h', sound: 'Like "h" in "hello"', type: 'consonant', example: '하늘', exampleMeaning: 'sky', tip: 'Looks like a person wearing a hat' },
    ],
  },
  {
    title: 'Basic Vowels',
    ...
    chars: [
      { char: 'ㅏ', name: '아', romanization: 'a', sound: 'Like "a" in "father"', type: 'vowel', example: '아빠', exampleMeaning: 'dad', tip: 'Vertical line with stroke to the RIGHT' },
      { char: 'ㅑ', name: '야', romanization: 'ya', sound: 'Like "ya" in "yard"', type: 'vowel', example: '야구', exampleMeaning: 'baseball', tip: 'Double stroke to the right = adds "y" sound' },
      { char: 'ㅓ', name: '어', romanization: 'eo', sound: 'Like "u" in "bus"', type: 'vowel', example: '엄마', exampleMeaning: 'mom', tip: 'Vertical line with stroke to the LEFT' },
      { char: 'ㅕ', name: '여', romanization: 'yeo', sound: 'Like "yo" in "young"', type: 'vowel', example: '여자', exampleMeaning: 'woman', tip: 'Double stroke to the left = adds "y" sound' },
      { char: 'ㅗ', name: '오', romanization: 'o', sound: 'Like "o" in "old"', type: 'vowel', example: '오빠', exampleMeaning: 'older brother', tip: 'Horizontal line with stroke going UP' },
      { char: 'ㅛ', name: '요', romanization: 'yo', sound: 'Like "yo" in "yoga"', type: 'vowel', example: '요리', exampleMeaning: 'cooking', tip: 'Double stroke up = adds "y" sound' },
      { char: 'ㅜ', name: '우', romanization: 'u', sound: 'Like "oo" in "moon"', type: 'vowel', example: '우유', exampleMeaning: 'milk', tip: 'Horizontal line with stroke going DOWN' },
      { char: 'ㅠ', name: '유', romanization: 'yu', sound: 'Like "you"', type: 'vowel', example: '유리', exampleMeaning: 'glass', tip: 'Double stroke down = adds "y" sound' },
      { char: 'ㅡ', name: '으', romanization: 'eu', sound: 'Like "oo" but with lips spread (not rounded)', type: 'vowel', example: '그림', exampleMeaning: 'picture', tip: 'Just a horizontal line - spread your lips saying "oo"' },
      { char: 'ㅣ', name: '이', romanization: 'i', sound: 'Like "ee" in "see"', type: 'vowel', example: '이름', exampleMeaning: 'name', tip: 'Just a vertical line - easiest vowel!' },
    ],
  },
  {
    ...
    chars: [
      { char: 'ㄲ', name: '쌍기역', romanization: 'kk', sound: 'Tense "k" - no air released', type: 'double_consonant', example: '꽃', exampleMeaning: 'flower', tip: 'Like "k" but tighter in throat, no breath' },
      { char: 'ㄸ', name: '쌍디귿', romanization: 'tt', sound: 'Tense "t" - no air released', type: 'double_consonant', example: '떡', exampleMeaning: 'rice cake', tip: 'Like "t" but tighter, think of tteokbokki!' },
      { char: 'ㅃ', name: '쌍비읍', romanization: 'pp', sound: 'Tense "p" - no air released', type: 'double_consonant', example: '빵', exampleMeaning: 'bread', tip: 'Like "p" but tighter, no breath' },
      { char: 'ㅆ', name: '쌍시옷', romanization: 'ss', sound: 'Tense "s" - sharper hiss', type: 'double_consonant', example: '씨', exampleMeaning: 'Mr./Ms. (suffix)', tip: 'Sharper and stronger than regular ㅅ' },
      { char: 'ㅉ', name: '쌍지읒', romanization: 'jj', sound: 'Tense "j" - no air released', type: 'double_consonant', example: '짜장면', exampleMeaning: 'black bean noodles', tip: 'Like "j" but tighter, think of jjajangmyeon!' },
    ],
  },
  {
    ...
    chars: [
      { char: 'ㅐ', name: '애', romanization: 'ae', sound: 'Like "a" in "bad"', type: 'double_vowel', example: '개', exampleMeaning: 'dog', tip: 'ㅏ + ㅣ combined = "ae" sound' },
      { char: 'ㅔ', name: '에', romanization: 'e', sound: 'Like "e" in "bed"', type: 'double_vowel', example: '세계', exampleMeaning: 'world', tip: 'ㅓ + ㅣ combined = "e" sound' },
      { char: 'ㅘ', name: '와', romanization: 'wa', sound: 'Like "wa" in "water"', type: 'double_vowel', example: '과자', exampleMeaning: 'snack', tip: 'ㅗ + ㅏ = "wa" - say them fast together!' },
      { char: 'ㅙ', name: '왜', romanization: 'wae', sound: 'Like "we" in "wet"', type: 'double_vowel', example: '왜', exampleMeaning: 'why', tip: 'ㅗ + ㅐ = "wae"' },
      { char: 'ㅚ', name: '외', romanization: 'oe', sound: 'Like "we" in "wet" (similar to ㅙ)', type: 'double_vowel', example: '외국', exampleMeaning: 'foreign country', tip: 'ㅗ + ㅣ = modern pronunciation is similar to "we"' },
      { char: 'ㅝ', name: '워', romanization: 'wo', sound: 'Like "wo" in "wonder"', type: 'double_vowel', example: '원', exampleMeaning: 'won (currency)', tip: 'ㅜ + ㅓ = "wo" - say them fast!' },
      { char: 'ㅞ', name: '웨', romanization: 'we', sound: 'Like "we" in "wet"', type: 'double_vowel', example: '웨딩', exampleMeaning: 'wedding', tip: 'ㅜ + ㅔ = "we"' },
      { char: 'ㅟ', name: '위', romanization: 'wi', sound: 'Like "wee" in "week"', type: 'double_vowel', example: '위', exampleMeaning: 'above/top', tip: 'ㅜ + ㅣ = "wi"' },
      { char: 'ㅢ', name: '의', romanization: 'ui', sound: '"eu" + "ee" said quickly', type: 'double_vowel', example: '의사', exampleMeaning: 'doctor', tip: 'ㅡ + ㅣ = slide from "eu" to "ee"' },
      { char: 'ㅒ', name: '얘', romanization: 'yae', sound: 'Like "yeh"', type: 'double_vowel', example: '얘기', exampleMeaning: 'story/talk', tip: 'ㅑ + ㅣ = "yae" - rare in modern Korean' },
      { char: 'ㅖ', name: '예', romanization: 'ye', sound: 'Like "ye" in "yes"', type: 'double_vowel', example: '예', exampleMeaning: 'yes (polite)', tip: 'ㅕ + ㅣ = "ye"' },
    ],
  },
];
